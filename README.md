...
dict1={}.fromkeys('bcdfghjklmnpqrstvwxyz',"consonant")
...
#output:
{'Burger King': 'Whopper', 'Chick-fil-A': 'Original Chicken Sandwich'}
```
```
...
internet_celebrities1=internet_celebrities.copy()
